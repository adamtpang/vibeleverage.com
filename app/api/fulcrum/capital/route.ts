import { listJobs, startCapitalJob } from "@/lib/fulcrum/capital-jobs";

// Fulcrum Capital shells out to the local `claude` CLI for research, same as
// Fulcrum Media and Code. Runs fine on Vercel's Node runtime in principle
